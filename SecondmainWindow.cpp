...
SecondmainWindow::SecondmainWindow(QWidget *parent)
    : QMainWindow(parent)
    , ui(new Ui::SecondmainWindow), Etmp(0, "default", 0.0, "default room", QDate::currentDate())
...
void SecondmainWindow::on_pb1_clicked()
{
...
void SecondmainWindow::on_pb2_clicked()
{
    ui->tableView->setModel(Etmp.afficher());
}

void SecondmainWindow::on_pb3_clicked()
{
    int id = ui->lineEdit_ID->text().toInt();
...
void SecondmainWindow::on_pushButton_Export_clicked()
{
...
void SecondmainWindow::on_pushButton_Convert_clicked()
{
    double price = ui->lineEdit_Price->text().toDouble();
...
void SecondmainWindow::on_start_listening_5_clicked()
{
...
void SecondmainWindow::on_button5_clicked()
{
    this->hide(); // Hide the second window
       if (QWidget *parentWindow = qobject_cast<QWidget *>(this->parent())) {
           parentWindow->show(); // Show the main window
       }
}
